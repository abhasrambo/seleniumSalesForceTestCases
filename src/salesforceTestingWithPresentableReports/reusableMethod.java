...
public class reusableMethod {
	...
	public static void enterDataForMethodSetByFields ( WebElement obj , String textFieldValue , String objName ) throws IOException
	{
		if(obj.isDisplayed())
		{
			obj.sendKeys(textFieldValue);
			System.out.println("Pass:\t" + textFieldValue + "\tis entered in\t" + objName + "\tfield");
			Update_Report( "Pass", objName,  "Test Case was passed succesfully");
			
		}
		else
		{
			System.out.println("Fail:\t" + objName + "\tis not entered in field");
			Update_Report( "Fail", objName,  " Test Case was not passed succesfully");
	...
	public static void click (WebElement obj , String loginClick) throws IOException
	{
		...
		{
			obj.click();
			System.out.println("Pass:\t" +  loginClick + "\tclick operation passed");
			Update_Report( "Pass", loginClick,  " Test Case was passed succesfully");
			
		}
		else
		{
			System.out.println("Fail:\t" + loginClick + "\tclick operation Failed");
			Update_Report( "Fail", loginClick,  " Test Case was not passed succesfully");
		}
	}
	...
	public static void startReport(String scriptName, String ReportsPath) throws IOException{
		...
		if (ReportsPath == "") { 
			...
			ReportsPath = "/Users/abhaskumar/Desktop/Report/";
		}
